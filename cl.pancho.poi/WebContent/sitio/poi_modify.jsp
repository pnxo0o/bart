	            ...
	            $.ajax({
	                ...
	                success: function (xml) {                   
	                    $(xml).find('poi').each(function () {
	                		...
	                		document.getElementById('ntipo').value = tipo;
...
/** validador de datos del formulario**/
        ...
        function validardatos(formObj) {
            ...
            if ( (formObj.ntipo.value) == "") { 
                alert ("No indicó el nuevo tipo del punto de interés");
                return false;
            }
...
<ul class="nav">
	...
	<li>
		...
		<ul>
			...
			<li><a href="#">Modificar Punto de Interés<span class="flecha">&#9660;</span></a></li>
...
<div id="main">
	...
	<form action="poi_modify_action.jsp" method="post" onsubmit="return validardatos(this);">
		...
		<p><input type="submit" value="Modificar Punto"></p>
	</form>
	</div>
	<div id="main1">
