...
<%
	...
	if(w.insertarNuevoPoi((String)request.getParameter("nombre"), (String)request.getParameter("tipo"),(String)request.getParameter("lat"),(String)request.getParameter("lon"))==1){
		response.sendRedirect("poi_add_ok.jsp");	
	}
	else{
	response.sendRedirect("poi_add_nok.jsp");	
	}
 %>
